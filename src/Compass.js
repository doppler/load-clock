...
const Compass = ({currentWind}) =>
  <div className="Compass">
    <svg xmlns="http://www.w3.org/2000/svg" id="svg_compass" viewBox="0,0,135,135" className="svg-content" width="97%" height="97%">
     <g>
       ...
       <g id="g11">
         ...
         <circle fill="#000000" stroke="#000000" cx="67" cy="67" r="33" id="svg_cwindbg"/>
         <text fill="#FFF" stroke="#FFF" strokeWidth="0" x="67" y="82" id="svg_cwind" fontSize="48" fontFamily="Sans-serif" textAnchor="middle">{currentWind}</text>
       </g>
     </g>
   </svg>
  </div>
